...
def load_matches():
    ...
    df_final.to_sql(con=engine, index_label='id', name=Match.__tablename__, if_exists='replace')
...
def load_teams():
    ...
    df.to_sql(con=engine, index_label='TeamID', name=Team.__tablename__, if_exists='replace')
